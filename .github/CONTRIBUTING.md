...
{
  "devDependencies": {
    "webpack-loader-guide": "null/webpack-loader-guide#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/null/webpack-loader-guide).
